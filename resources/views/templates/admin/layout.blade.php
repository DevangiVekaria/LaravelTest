...
<head>
    ...
    <title>{{$title or "Amar Repowering Admin Panel"}}</title>
    ...
    <!-- iCheck -->
    <link href="{{asset('public/admin/css/green.css')}}" rel="stylesheet">
    <!-- bootstrap-progressbar -->
    <link href="{{asset('public/admin/css/bootstrap-progressbar-3.3.4.min.css')}}" rel="stylesheet">
    <!-- JQVMap -->
    <link href="{{asset('public/admin/css/jqvmap.min.css')}}" rel="stylesheet"/>
    <!-- Custom Theme Style -->
    ...
    <link href="{{asset('public/admin/css/buttons.bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('public/admin/css/fixedHeader.bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('public/admin/css/responsive.bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('public/admin/css/scroller.bootstrap.min.css')}}" rel="stylesheet">
</head>
...
<body class="nav-md">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-edit"></i> Parts <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                       <li><a href="{{route('parts.index')}}"><i class="fa fa-user"></i> Parts </a></li>
                                ...
                                <li><a href="{{route('users.index')}}"><i class="fa fa-users"></i> Users </a></li>
								 ...
								 <li><a href="{{route('invoice.index')}}"><i class="fa fa-users"></i> Invoice </a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- /sidebar menu -->
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <img src="{{asset('public/admin/images/img.jpg')}}" alt="">Rodrick K
    ...
    <script src="{{asset('public/admin/js/buttons.bootstrap.min.js')}}"></script>
    ...
    <script src="{{asset('public/admin/js/dataTables.fixedHeader.min.js')}}"></script>
    <script src="{{asset('public/admin/js/dataTables.keyTable.min.js')}}"></script>
    <script src="{{asset('public/admin/js/dataTables.responsive.min.js')}}"></script>
    <script src="{{asset('public/admin/js/responsive.bootstrap.js')}}"></script>
    <script src="{{asset('public/admin/js/datatables.scroller.min.js')}}"></script>
